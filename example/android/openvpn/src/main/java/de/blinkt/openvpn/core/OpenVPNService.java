...
//                    .setAutoCancel(true)
            ...
            if (mProfile != null) {
                nbuilder.setContentTitle(getString(R.string.notifcation_title, /*mProfile.mConnections[0].mServerName, mProfile.mUsername*/ getApplicationContext().getString(R.string.app_name), mProfile.getName()));
            } else {
